        ...
        <header id="main-header">
            ...
            <div className="bottom-part">
                <div className="header-logo">
                    ...
                    <Link to="/" className='logo-title'>ShopSite</Link>
                </div>
                <form action='/' method='get' className="header-form-search">
                    <div className="dropdown-department">  
                        ...
                        { props.departments.map((val) => {
                            return  <Link to={'/searchResults?keyword='+val} key={val}>{val}</Link>;
                            })
                        }
                        </ul>
                    </div>	
                    <input type="search" name='keyword' onChange={findSuggestions} 
