...
function OrderOfflineBanner() {
  return (
    <div id="order-offline-banner">
      ...
      <h3>
        Quiere hacer una compra y no tiene tarjeta de credito o debito, llamé
        al: 809-100-2000 realice su compra con ayuda de nuestro servicio al
        cliente y pague al recibir.
      </h3>
    </div>
  );
}
