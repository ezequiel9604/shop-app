                ...
                <div className="modal-content">
                    ...
                    <form action="/">
                        ...
                        <div className="modal-input-box">
                            ...
                            <input type="text" id="street" placeholder="nombre de la calle y apart no." />
                            <select name="">
        ...
        return (
            <div id="modal">
                ...
                <div className="modal-content">
                    ...
                    <span className="title-modal">Para guardar los cambios es necesario introducir la contraseña:</span>

                    <form action="/">
                        <label>Contraseña:</label>
                        <input type="password" placeholder="Introducir Contraseña aqui..." />
                        <button type="button">Guardar Cambios</button>
                    </form>
